...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/CSCNOK01
RAW_DIR=../02_raw/CSCNOK01
CYNAPSE_CONFIG=../01_config/CynapseCSCNOK01.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunCSCNOK01.txt
SKIPPEDFILE=skippedCSCNOK01.txt
