...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/CSCNOK02
RAW_DIR=../02_raw/CSCNOK02
CYNAPSE_CONFIG=../01_config/CynapseCSCNOK02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunCSCNOK02.txt
SKIPPEDFILE=skippedCSCNOK02.txt
