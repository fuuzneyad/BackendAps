...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/3GRERI03
RAW_DIR=../02_raw/3GRERI03
CYNAPSE_CONFIG=../01_config/Cynapse3GRERI03.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRERI03.txt
SKIPPEDFILE=skipped3GRERI03.txt
