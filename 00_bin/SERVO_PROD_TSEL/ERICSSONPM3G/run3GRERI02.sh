...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/3GRERI02
RAW_DIR=../02_raw/3GRERI02
CYNAPSE_CONFIG=../01_config/Cynapse3GRERI02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRERI02.txt
SKIPPEDFILE=skipped3GRERI02.txt
