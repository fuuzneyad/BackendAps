...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/PSCSASNERI02
RAW_DIR=../02_raw/PSCSASNERI02
CYNAPSE_CONFIG=../01_config/CynapsePSCSASNERI02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunPSCSASN02.txt
SKIPPEDFILE=skippedPSCSASN02.txt
