...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/PSCGGSNERIPGW01
RAW_DIR=../02_raw/PSCGGSNERIPGW01
CYNAPSE_CONFIG=../01_config/CynapsePSCGGSNERIPGW01.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunPSCGGSNERIPGW01.txt
SKIPPEDFILE=skippedPSCGGSNERIPGW01.txt
