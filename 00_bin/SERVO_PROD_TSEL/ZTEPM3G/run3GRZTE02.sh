...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/3GRZTE02
RAW_DIR=../02_raw/3GRZTE02
CYNAPSE_CONFIG=../01_config/Cynapse3GRZTE02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRZTE02.txt
SKIPPEDFILE=skipped3GRZTE02.txt
LOADFILE=loadZte02.sh
##########################################################################
