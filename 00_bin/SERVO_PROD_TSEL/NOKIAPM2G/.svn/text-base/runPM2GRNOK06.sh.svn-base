...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRNOK06
RAW_DIR=../02_raw/2GRNOK06
CYNAPSE_CONFIG=../01_config/Cynapse2GRNOK06.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRNOK06.txt
SKIPPEDFILE=skipped2GRNOK06.txt
LOADFILE=loadNok06.sh
##########################################################################
