...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRNOK05
RAW_DIR=../02_raw/2GRNOK05
CYNAPSE_CONFIG=../01_config/Cynapse2GRNOK05.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRNOK05.txt
SKIPPEDFILE=skipped2GRNOK05.txt
LOADFILE=loadNok05.sh
##########################################################################
