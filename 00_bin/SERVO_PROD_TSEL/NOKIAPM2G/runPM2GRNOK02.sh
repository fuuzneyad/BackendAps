...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRNOK02
RAW_DIR=../02_raw/2GRNOK02
CYNAPSE_CONFIG=../01_config/Cynapse2GRNOK02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRNOK02.txt
SKIPPEDFILE=skipped2GRNOK02.txt
