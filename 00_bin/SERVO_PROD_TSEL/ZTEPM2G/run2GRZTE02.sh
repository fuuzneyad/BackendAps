...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRZTE02
RAW_DIR=../02_raw/2GRZTE02
CYNAPSE_CONFIG=../01_config/Cynapse2GRZTE02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRZTE02.txt
SKIPPEDFILE=skipped2GRZTE02.txt
