...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/3GRNOK02
RAW_DIR=../02_raw/3GRNOK02
CYNAPSE_CONFIG=../01_config/Cynapse3GRNOK02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRNOK02.txt
SKIPPEDFILE=skipped3GRNOK02.txt
