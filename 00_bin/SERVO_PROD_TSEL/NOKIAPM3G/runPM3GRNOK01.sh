...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/3GRNOK01
RAW_DIR=../02_raw/3GRNOK01
CYNAPSE_CONFIG=../01_config/Cynapse3GRNOK01.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRNOK01.txt
SKIPPEDFILE=skipped3GRNOK01.txt
