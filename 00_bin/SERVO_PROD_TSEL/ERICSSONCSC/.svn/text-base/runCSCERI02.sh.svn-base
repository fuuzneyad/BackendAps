...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/CSCERI02
RAW_DIR=../02_raw/CSCERI02
CYNAPSE_CONFIG=../01_config/CynapseCSCERI02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunCSCERI02.txt
SKIPPEDFILE=skippedCSCERI02.txt
