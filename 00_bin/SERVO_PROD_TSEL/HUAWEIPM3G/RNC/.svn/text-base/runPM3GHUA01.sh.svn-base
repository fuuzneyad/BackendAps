...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/3GRHUA01
RAW_DIR=../02_raw/3GRHUA01
CYNAPSE_CONFIG=../01_config/Cynapse3GRHUA01.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRHUA01.txt
SKIPPEDFILE=skipped3GRHUA01.txt
