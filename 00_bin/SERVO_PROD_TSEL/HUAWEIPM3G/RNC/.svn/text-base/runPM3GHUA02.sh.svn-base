...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/3GRHUA02
RAW_DIR=../02_raw/3GRHUA02
CYNAPSE_CONFIG=../01_config/Cynapse3GRHUA02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRHUA02.txt
SKIPPEDFILE=skipped3GRHUA02.txt
