...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/3GRHUA03
RAW_DIR=../02_raw/3GRHUA03
CYNAPSE_CONFIG=../01_config/Cynapse3GRHUA03.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRHUA03.txt
SKIPPEDFILE=skipped3GRHUA03.txt
LOADFILE=loadHua03.sh
##########################################################################
