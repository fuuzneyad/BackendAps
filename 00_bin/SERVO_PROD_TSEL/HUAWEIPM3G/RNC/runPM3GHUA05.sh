...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/3GRHUA05
RAW_DIR=../02_raw/3GRHUA05
CYNAPSE_CONFIG=../01_config/Cynapse3GRHUA05.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun3GRHUA05.txt
SKIPPEDFILE=skipped3GRHUA05.txt
