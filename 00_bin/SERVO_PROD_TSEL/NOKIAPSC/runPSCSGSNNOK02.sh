...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/PSCNOKSGSN02
RAW_DIR=../02_raw/PSCNOKSGSN02
CYNAPSE_CONFIG=../01_config/CynapsePSCSGSNNOK02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunPSCNOKSGSN02.txt
SKIPPEDFILE=skippedPSCNOKSGSN02.txt
LOADFILE=loadNok02.sh
##########################################################################
