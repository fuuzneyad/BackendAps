...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/PSCNOKSGSN01
RAW_DIR=../02_raw/PSCNOKSGSN01
CYNAPSE_CONFIG=../01_config/CynapsePSCSGSNNOK01.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunPSCNOKSGSN01.txt
SKIPPEDFILE=skippedPSCNOKSGSN01.txt
