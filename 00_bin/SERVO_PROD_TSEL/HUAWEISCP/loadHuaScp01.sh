...
MYSQL_SCHEMA=SERVO_CSCHUA02

LOA_FOLDER=../04_loader/CSCHUA01
SCHEMA=SERVO_CSCHUA01
LIST_FILE=lstSERVO_CSCHUA01.txt
LOG_FOLDER=../05_log/LOAD_SERVO_CSCHUA01.log
...
do
  ...
  mysql -u$MYSQL_USERNAME -p$MYSQL_PASSWORD -h$MYSQL_HOST -P$MYSQL_PORT $MYSQL_SCHEMA -e "set sql_log_bin=0; LOAD DATA LOCAL INFILE '$F' REPLACE INTO TABLE $TABLE fields terminated by ',' enclosed by '\"' lines terminated by '\n';"
