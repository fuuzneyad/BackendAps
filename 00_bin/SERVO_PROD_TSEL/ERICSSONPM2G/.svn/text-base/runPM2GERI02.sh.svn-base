...
BACKUP_DIR=../08_backup/2GRERI02
RAW_DIR=../02_raw/2GRERI02
CONFIG_FILE=../01_config/Cynapse2GRERI02.cfg
SCHEMA=SERVO_2GRERI02
INPROGRESSFILE=inProgress2GRERI02.txt
SKIPPEDFILE=skipped2GRERI02.txt
LOADFILE=loadEri02.sh

##########################################################################
cd $H_DIR
rm -f ../05_log/2GRERI02*
...
./$LOADFILE
#maintain csv
/data01/ftpuser1/SERVO_CSV_DUMP/ERICSSONPM2G/maintain02.sh
