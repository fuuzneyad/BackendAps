...
LOG_FILE1=../05_log/yesterday3_eri1.txt
LOG_FILE2=../05_log/yesterday3_eri2.txt
LOG_FILE3=../05_log/yesterday3_eri3.txt
LOG_FILE4=../05_log/yesterday3_eri4.txt
tanggal=`date -d '3 day ago' +'C%Y%m%d'`
