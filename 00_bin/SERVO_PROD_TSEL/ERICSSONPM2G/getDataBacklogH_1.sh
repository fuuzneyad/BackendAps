...
LOG_FILE1=../05_log/yesterday1_eri1.txt
LOG_FILE2=../05_log/yesterday1_eri2.txt
LOG_FILE3=../05_log/yesterday1_eri3.txt
LOG_FILE4=../05_log/yesterday1_eri4.txt
tanggal=`date -d '1 day ago' +'C%Y%m%d'`
