...
CONFIG_FILE=../01_config/CynapseCLIERIMSC.cfg
LOADFILE=loadCLIMSC.sh
DATE_PARAM=`date '+%Y%m%d'`
RAW_DIR1=../02_raw/MSC01/
RAW_DIR2=../02_raw/MSC02/
BACKUP_DIR1=../08_backup/MSC01/
BACKUP_DIR2=../08_backup/MSC02/
INPROGRESS_FILE=inProgressMSC.txt
SKIPPFILE=skippedParserMSC.txt
