...
LIST_FILE=lstSERVO_ERIMSSCLI01.txt
LOG_FOLDER=../05_log/LOAD_SERVO_ERIMSSCLI01.log
...
/usr/bin/mysql -u$MYSQL_USERNAME -p$MYSQL_PASSWORD -h$MYSQL_HOST -P$MYSQL_PORT $MYSQL_SCHEMA -e "call ERICSSON_MSC_CLI();"
