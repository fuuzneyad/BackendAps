...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/MMLTASK01
RAW_DIR=../02_raw/MMLTASK01
CYNAPSE_CONFIG=../01_config/CynapseHuaMMLTask.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRunHuaMMLtask.txt
SKIPPEDFILE=skippedHuaMMLtask.txt
LOADFILE=load.sh
##########################################################################
