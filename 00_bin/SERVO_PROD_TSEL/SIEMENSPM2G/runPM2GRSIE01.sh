...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRSIE01
RAW_DIR=../02_raw/2GRSIE01
CYNAPSE_CONFIG=../01_config/Cynapse2GRSIE01.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRSIE01.txt
SKIPPEDFILE=skipped2GRSIE01.txt
LOADFILE=loadSie01.sh
##########################################################################
