...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRSIE03
RAW_DIR=../02_raw/2GRSIE03
CYNAPSE_CONFIG=../01_config/Cynapse2GRSIE03.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRSIE03.txt
SKIPPEDFILE=skipped2GRSIE03.txt
LOADFILE=loadSie03.sh
##########################################################################
