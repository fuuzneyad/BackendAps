...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRSIE04
RAW_DIR=../02_raw/2GRSIE04
CYNAPSE_CONFIG=../01_config/Cynapse2GRSIE04.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRSIE04.txt
SKIPPEDFILE=skipped2GRSIE04.txt
LOADFILE=loadSie04.sh
##########################################################################
