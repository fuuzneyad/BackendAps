...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRSIE05
RAW_DIR=../02_raw/2GRSIE05
CYNAPSE_CONFIG=../01_config/Cynapse2GRSIE05.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRSIE05.txt
SKIPPEDFILE=skipped2GRSIE05.txt
LOADFILE=loadSie05.sh
##########################################################################
