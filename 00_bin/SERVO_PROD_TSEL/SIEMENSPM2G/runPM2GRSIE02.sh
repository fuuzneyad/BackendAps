...
################## Must Be Filled!!   ####################################
BACKUP_DIR=../08_backup/2GRSIE02
RAW_DIR=../02_raw/2GRSIE02
CYNAPSE_CONFIG=../01_config/Cynapse2GRSIE02.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRSIE02.txt
SKIPPEDFILE=skipped2GRSIE02.txt
LOADFILE=loadSie02.sh
##########################################################################
