...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/2GRHUA06
RAW_DIR=../02_raw/2GRHUA06
CYNAPSE_CONFIG=../01_config/Cynapse2GRHUA06.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRHUA06.txt
SKIPPEDFILE=skipped2GRHUA06.txt
LOADFILE=loadHua06.sh
##########################################################################
