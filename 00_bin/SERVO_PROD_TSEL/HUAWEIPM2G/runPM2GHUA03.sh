...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/2GRHUA03
RAW_DIR=../02_raw/2GRHUA03
CYNAPSE_CONFIG=../01_config/Cynapse2GRHUA03.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRHUA03.txt
SKIPPEDFILE=skipped2GRHUA03.txt
