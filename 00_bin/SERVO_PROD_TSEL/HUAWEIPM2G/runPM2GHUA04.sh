...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/2GRHUA04
RAW_DIR=../02_raw/2GRHUA04
CYNAPSE_CONFIG=../01_config/Cynapse2GRHUA04.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRHUA04.txt
SKIPPEDFILE=skipped2GRHUA04.txt
