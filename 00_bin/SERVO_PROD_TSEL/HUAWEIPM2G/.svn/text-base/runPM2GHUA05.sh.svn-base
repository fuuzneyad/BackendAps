...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/2GRHUA05
RAW_DIR=../02_raw/2GRHUA05
CYNAPSE_CONFIG=../01_config/Cynapse2GRHUA05.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRHUA05.txt
SKIPPEDFILE=skipped2GRHUA05.txt
LOADFILE=loadHua05.sh
##########################################################################
