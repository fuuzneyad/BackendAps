...
################## Must Be Filled!!   ####################################
#type file=>GZ|XML
BACKUP_DIR=../08_backup/2GRHUA01
RAW_DIR=../02_raw/2GRHUA01
CYNAPSE_CONFIG=../01_config/Cynapse2GRHUA01.cfg
LOG_FILE=../05_log/
INPROGRESSFILE=inProgressiRun2GRHUA01.txt
SKIPPEDFILE=skipped2GRHUA01.txt
