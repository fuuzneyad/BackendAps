...
CONFIG_FILE=../01_config/CynapseCLINOKPSC.cfg
LOADFILE=loadCLIMSC.sh
DATE_PARAM=`date '+%Y%m%d'`
RAW_DIR1=../02_raw/PSCNOK01
RAW_DIR2=../02_raw/PSCNOK02
BACKUP_DIR1=../08_backup/PSCNOK01
BACKUP_DIR2=../08_backup/PSCNOK02
INPROGRESS_FILE=inProgressPSC.txt
SKIPPFILE=skippedParserPSC.txt
