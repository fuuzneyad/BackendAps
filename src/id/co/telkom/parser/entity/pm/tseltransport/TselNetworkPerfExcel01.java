...
public class TselNetworkPerfExcel01 extends AbstractParser{
	private Map<String, StandardMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(TselNetworkPerfExcel01.class);
	
	@SuppressWarnings("unchecked")
	public TselNetworkPerfExcel01(ParserPropReader cynapseProp,
		                ...
		                if(o!=null){
			                ...
			                if(header.get("H"+posX)!=null) {
			                		...
			                		if(cynapseProp.isGENERATE_SCHEMA_MODE()){
					            		PutModel(ctx.t_name, header.get("H"+posX), s);
					            }
			                }
		                }
		            }
...
//			            	 loader.onReadyModel(map, ctx);
	...
	protected void CreateSchemaFromMap() {
		try{
			String location=cynapseProp.getFILE_SCHEMA_LOC()+"Transport.sql";
