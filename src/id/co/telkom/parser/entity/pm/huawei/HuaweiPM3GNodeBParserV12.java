...
public class HuaweiPM3GNodeBParserV12 extends AbstractParser{
	private ParserPropReader cynapseProp;
	private Map<String, StandardMeasurementModel> modelMap;
	private Map<String, Object> map = new LinkedHashMap<String, Object>();
	private static final Logger logger = Logger.getLogger(HuaweiPM3GNodeBParserV12.class);
	
	@SuppressWarnings("unchecked")
	public HuaweiPM3GNodeBParserV12(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
	...
	public synchronized void  ProcessFile(File file,  final LoaderHandlerManager loader,  final Context ctx) throws Exception {
			...
			String ne = filename.contains("RNC_") ? filename.substring(filename.indexOf("RNC_")).replace(".xml", "") : filename.substring(30,filename.length()).replace(".xml", "");
			ctx.setNe_id(ne);
			loader.onBeginFile();
