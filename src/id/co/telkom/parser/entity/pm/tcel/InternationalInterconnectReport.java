...
public class InternationalInterconnectReport  extends AbstractParser{
	private Map<String, StandardMeasurementModel> modelMap;
	
	@SuppressWarnings("unchecked")
	public InternationalInterconnectReport(ParserPropReader cynapseProp,
	...
	protected void ProcessFile(File file, LoaderHandlerManager loader,
		...
		ctx.setTableName("INTERNATIONAL_INTCONNECT_TEMP");
