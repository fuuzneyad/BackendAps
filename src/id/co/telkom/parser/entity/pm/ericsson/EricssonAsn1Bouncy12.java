...
public class EricssonAsn1Bouncy12 extends AbstractParser{
	private Map<String, String> header  = new LinkedHashMap<String, String>();
//	private Map<String, Object> map  = new LinkedHashMap<String, Object>();
	private static final Logger logger = Logger.getLogger(EricssonAsn1Bouncy12.class);
	@SuppressWarnings("unused")
	private boolean isImplicit;
	@SuppressWarnings("unused")
	private int hCounter,cCounter,berSeq,derSeq,tagNo,tempBerSeq=0;
//	private boolean isCounter=false;
//	private String t_name,ne;
	
	public EricssonAsn1Bouncy12(ParserPropReader cynapseProp,
