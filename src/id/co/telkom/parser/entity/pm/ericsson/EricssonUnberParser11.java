...
public class EricssonUnberParser11 extends AbstractParser{
	private ParserPropReader cynapseProp;
	private Map<String, StandardMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(EricssonUnberParser11.class);
	
	@SuppressWarnings("unchecked")
	public EricssonUnberParser11(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
