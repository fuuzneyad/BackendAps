...
public class EricssonPSCSgsnParserV11 extends AbstractParser{
	private ParserPropReader cynapseProp;
	private Map<String, StandardMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(EricssonPSCSgsnParserV11.class);
	
	@SuppressWarnings("unchecked")
	public EricssonPSCSgsnParserV11(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
			    ...
			    br = new BufferedReader(new InputStreamReader(new DataInputStream(fstream)));	
			      ...
			      while ((stringLine = br.readLine()) != null)
			      {
					  ...
					  if(stringLine.startsWith("<gp>")){ 
						  ctx.setGranularity(Integer.parseInt(GetMeas(stringLine)));
					  }else
					  ...
					  if(stringLine.startsWith("<r>")){
						  ...
						  measCounter++;
					  }else  if((stringLine.startsWith("</mdc>")||stringLine.startsWith("</mv>")) && !cynapseProp.isGENERATE_SCHEMA_MODE() ){
