...
import id.co.telkom.parser.entity.pm.nokia.model.NokiaCSCMeasurementModel;

public class NokiaCSCXmlParser13 extends AbstractParser {
	private ParserPropReader cynapseProp;
	private Map<String, NokiaCSCMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(NokiaCSCXmlParser13.class);
	private FileInputStream fstream=null;
	private Reader reader=null;
	
	@SuppressWarnings("unchecked")
	public NokiaCSCXmlParser13(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
		super(cynapseProp, cynapseInit);
		this.modelMap = (Map<String, NokiaCSCMeasurementModel>)cynapseInit.getMappingModel();
	...
	public synchronized void  ProcessFile(File file,  final LoaderHandlerManager loader,  final Context ctx) throws Exception {
	    final NokiaCSCMeasurementModel mapField = this.modelMap.get("default_mapping_field");
	    try{
			...
			DefaultHandler handler = new DefaultHandler() {
				...
				private NokiaCSCMeasurementModel mdl;
