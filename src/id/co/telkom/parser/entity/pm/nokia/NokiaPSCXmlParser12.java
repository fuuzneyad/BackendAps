...
public class NokiaPSCXmlParser12 extends AbstractParser {
	private ParserPropReader cynapseProp;
	private Map<String, StandardMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(NokiaPSCXmlParser12.class);
	private FileInputStream fstream=null;
	private Reader reader=null;
	
	@SuppressWarnings("unchecked")
	public NokiaPSCXmlParser12(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
