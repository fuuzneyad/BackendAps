...
public class Nokia3GRXmlParser11 extends AbstractParser {
	private ParserPropReader cynapseProp;
	private Map<String, StandardMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(Nokia3GRXmlParser11.class);
	private FileInputStream fstream=null;
	private Reader reader=null;
	
	@SuppressWarnings("unchecked")
	public Nokia3GRXmlParser11(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
...
//							System.out.println(map);
				...
				public void characters(char[] ch, int start, int length)
					...
					if(qName.equals("DN") && read!=null & !read.equals("")){
						...
						String[] datas=moi.replace("PLMN-PLMN/", "").contains("/")?moi.replace("PLMN-PLMN/", "").split("/") : new String[0] ;
						for (String x:datas){
...
//							
					...
					if(qName.startsWith("M")&& read!=null & !read.equals("")){
...
//								fieldName=qName;
	...
	public void CreateSchemaFromMap(){
		try{
			String location=cynapseProp.getFILE_SCHEMA_LOC()+"Nokia3GSchema.sql";
