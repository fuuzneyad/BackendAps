...
public class Nokia3GRXmlParser10 extends AbstractParser{
	private ParserPropReader cynapseProp;
	private Map<String, StandardMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(Nokia3GRXmlParser10.class);
	private FileInputStream fstream=null;
	private Reader reader=null;
	
	@SuppressWarnings("unchecked")
	public Nokia3GRXmlParser10(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
...
//						System.out.println(qName+" "+read);
						...
						if(mdl!=null){
							fieldName = mdl.getFieldMap().get(qName);
							if(fieldName==null){
