...
public class ParserZWVICommandHandlerFactory implements MscCommandHandlerFactory {
	private static final String command = "ZWVI";
	private final ConfiguredHeader[] headers;
	
	public ParserZWVICommandHandlerFactory() {
	...
	public CommandHandler create(Parser extractor, String command,
			...
			return new ParserZWVICommandHandler( extractor, listener, getCommand(), params,headers,cynapseInit);
	}
