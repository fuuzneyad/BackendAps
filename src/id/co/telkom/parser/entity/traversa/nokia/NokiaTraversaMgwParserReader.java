...
import id.co.telkom.parser.entity.traversa.nokia.mgwcommand.ParserZQRICommandHandlerFactory;
import id.co.telkom.parser.entity.traversa.nokia.msscommand.UnhandledCommandHandlerFactory;

public class NokiaTraversaMgwParserReader extends CommandParser{
	private static final Logger logger = Logger.getLogger(NokiaTraversaMgwParserReader.class);
	...
	public NokiaTraversaMgwParserReader(Reader reader, DataListener listener, Context ctx, AbstractInitiator cynapseInit) {
		super(reader);
		this.ctx=ctx;
