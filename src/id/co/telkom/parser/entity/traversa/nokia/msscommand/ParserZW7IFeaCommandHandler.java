...
public class ParserZW7IFeaCommandHandler extends AbstractCommandHandler implements MscCommandHandler {
	private final Parser reader;
	private final DataListener listener;
	@SuppressWarnings("unused")
	private ConfiguredHeader[] headers;
	private final String T_NAME;
	private static final Logger logger = Logger.getLogger(ParserZW7IFeaCommandHandler.class);
	@SuppressWarnings("unused")
	private final GlobalBuffer gb;
	private boolean isStartExecution;
	Map<String, Object> map = new LinkedHashMap<String, Object>();
	
	public ParserZW7IFeaCommandHandler(
			Parser reader, 
