...
public class ParserWVICommandHandler extends AbstractCommandHandler implements MscCommandHandler {
	private final Parser reader;
	private final DataListener listener;
	private ConfiguredHeader[] headers;
	private final String T_NAME;
	private static final Logger logger = Logger.getLogger(ParserWVICommandHandler.class);
	private String MCountryCode, MNetworkCode, PLMNChargingArea, CoreNetIdtf, Type;
	
	public ParserWVICommandHandler(
			Parser reader, 
