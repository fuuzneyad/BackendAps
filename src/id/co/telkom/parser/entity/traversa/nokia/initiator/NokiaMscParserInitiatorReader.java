...
public class NokiaMscParserInitiatorReader extends CommandParser{
	private static final Logger logger = Logger.getLogger(NokiaMscParserInitiatorReader.class);
	...
	public NokiaMscParserInitiatorReader(Reader reader, Context ctx, GlobalBuffer buf) {
		super(reader);
		this.ctx=ctx;
		this.buf=buf;
