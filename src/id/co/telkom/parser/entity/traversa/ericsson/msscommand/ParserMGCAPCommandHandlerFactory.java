...
public class ParserMGCAPCommandHandlerFactory implements MscCommandHandlerFactory {
	private static final String command = "MGCAP";
	private ConfiguredHeader[] headers;
	
	public ParserMGCAPCommandHandlerFactory() {
	...
	public CommandHandler create(Parser extractor, String command,
			...
			return new ParserMGCAPCommandHandler( extractor, listener, command, params,headers,cynapseInit);
	}
