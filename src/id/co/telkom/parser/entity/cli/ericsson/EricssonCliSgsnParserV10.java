...
public class EricssonCliSgsnParserV10 extends AbstractParser {
	private ParserPropReader cynapseProp;
	private static final Logger logger = Logger.getLogger(EricssonCliSgsnParserV10.class);
	
	public EricssonCliSgsnParserV10(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
...
//					System.out.println(ctx.toString()+map);
			...
			new EricssonCliSgsnParserReaderV10(reader, listener, ctx).parse();
			reader.close();
			loader.onEndFile();
		}
	}
	...
	public void CreateSchemaFromMap(){
		try{
			...
			StringBuffer schema = new EricssonCliSgsnParserReaderV10(null, null, null).GenerateSchema();
