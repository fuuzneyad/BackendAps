...
public class ZusiCommandHandlerFactory implements MscCommandHandlerFactory {
	private static final String command = "USI";
	private final Map<String, ConfiguredHeader[]> headersMap = new LinkedHashMap<String, ConfiguredHeader[]>();
	
	public ZusiCommandHandlerFactory() {
		headersMap.put("USI",
				new ConfiguredHeader[]{
				new ConfiguredHeader(" UNIT       "),
				new ConfiguredHeader("PHYS_STATE_LOCATION              "),
	...
	public CommandHandler create(Parser extractor, String command,
		...
		return new ZusiCommandHandler(extractor, listener, command, params, headersMap, getCommand());
	}
