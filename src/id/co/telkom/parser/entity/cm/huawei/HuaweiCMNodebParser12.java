...
public class HuaweiCMNodebParser12 extends AbstractParser {
	private Map<String, String> tableConverted = new LinkedHashMap<String, String>();
	public HuaweiCMNodebParser12(ParserPropReader cynapseProp,
			...
			public void endElement(String uri, String localName,
				...
				if(qName.equals("attributes")){
					...
					if(!cynapseProp.isGENERATE_SCHEMA_MODE()){	
						...
						String dir_id = file.getName();
			            String dir_id1 = dir_id.replace("_", "/");
			            this.map.put("DIR_ID", dir_id1);
	...
	protected void CreateSchemaFromMap() {
		try{
			...
			for (Map.Entry<String, Map<String,String>> entry : tableModel.entrySet()) {
				...
				sb.append("\t`DIR_ID` varchar(300) DEFAULT NULL,\n");
