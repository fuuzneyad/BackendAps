...
public class NokiaCMParser11 extends AbstractParser{
	private Map<String, StandardMeasurementModel> modelMap;
	private Map<String, Object> map = new LinkedHashMap<String, Object>();
	@SuppressWarnings("unchecked")
	public NokiaCMParser11(ParserPropReader cynapseProp,
			...
			private Attributes attributes=null;
				...
				public void startElement(String uri, String localName,
					...
					if(qName.equals("managedObject")){
						...
						//tableName
						ctx.setTableName(getAttribute("class"));
				...
				public void characters(char[] ch, int start, int length)
					...
					if(this.qName.equals("p") && this.meas!=null && !c.equals("")){
						...
						String paramMapped = mapField.getFieldMap().get(param);
						param = paramMapped==null ? param:paramMapped;
						if(true){
			...
			for (Map.Entry<String, Map<String,String>> entry : tableModel.entrySet()) {
				...
				for (Map.Entry<String, String> entry2 : entry.getValue().entrySet()) {
					if(entry2.getKey()!=null && entry2.getKey().length()>30)
						System.out.println("Table ["+entry.getKey()+"]["+entry2.getKey()+ "] length are more 30 character length, field mapping required!!");
					if(entry2.getKey()!=null)
