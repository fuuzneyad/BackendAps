...
public class SapAllitemReaderV01 extends AbstractParser{
	public SapAllitemReaderV01(ParserPropReader cynapseProp,
		...
		Map<String, Object> map = new LinkedHashMap<String, Object>();
	      ...
	      while ((stringLine = br.readLine()) != null)
	      {
	    	  ...
	    	  if(stringLine.startsWith("Customer")){
	    		  ...
	    		  ctx.setTableName("sap_allitem_header".toUpperCase());
	    	  ...
	    	  if(stringLine.contains("Stat|BusA")){
	    		  ...
	    		  while ((stringLine = br.readLine()) != null && !stringLine.startsWith("|  ** Account")){
	    			  ctx.setTableName("sap_allitem_detail".toUpperCase());
