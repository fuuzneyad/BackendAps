...
public class RaoE2GRActiveAlarm extends AbstractParser{
	...
	final static String[] t_name = {"E2GRACTRAW"};
	private CharParserExtender chr=null;
	
	public RaoE2GRActiveAlarm(ParserPropReader cynapseProp,
		...
		headersMap.put("MASTER", new ConfiguredHeader[]{
				...
				new ConfiguredHeader("MANAGED_ELEMENT                                                                                                                                                                                                                                                 "),
