...
public class NokiaLTEXmlParser11 extends AbstractParser {
	private ParserPropReader cynapseProp;
	private Map<String, StandardMeasurementModel> modelMap;
	private static final Logger logger = Logger.getLogger(NokiaLTEXmlParser11.class);
	private FileInputStream fstream=null;
	private Reader reader=null;
	
	@SuppressWarnings("unchecked")
	public NokiaLTEXmlParser11(ParserPropReader cynapseProp, AbstractInitiator cynapseInit) {
...
//								fieldName=qName;
	...
	public void CreateSchemaFromMap(){
		try{
			String location=cynapseProp.getFILE_SCHEMA_LOC()+"NokiaLTERSchema.sql";
