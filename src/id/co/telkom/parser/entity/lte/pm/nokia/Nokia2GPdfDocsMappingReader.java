...
public class Nokia2GPdfDocsMappingReader extends AbstractParser{
	//this parser used to generate Mapping model from Nokia LTE Pdf Documentation
	
	public Nokia2GPdfDocsMappingReader(ParserPropReader cynapseProp,
	...
	protected void CreateSchemaFromMap() {
		...
		String location=cynapseProp.getFILE_SCHEMA_LOC()+"Nokia2GMapping.cfg";
