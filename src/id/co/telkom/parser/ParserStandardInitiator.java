...
public  class ParserStandardInitiator extends AbstractInitiator {
	private ParserPropReader cynapseProp;
	
	public ParserStandardInitiator(ParserPropReader cynapseProp, OutputMethodPropReader om) {
		super(cynapseProp, om);
		this.cynapseProp=cynapseProp;
		this.mappingModel=ReadMappingModel();//already called
	}
