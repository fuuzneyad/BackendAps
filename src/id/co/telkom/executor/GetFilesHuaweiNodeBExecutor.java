...
public class GetFilesHuaweiNodeBExecutor
{
  ...
  public static void main(String[] args)
  {
    ...
    GetFilesHuaweiNodeBExecutor getFile = new GetFilesHuaweiNodeBExecutor(args[0]);
  ...
  public GetFilesHuaweiNodeBExecutor(String config)
  {
