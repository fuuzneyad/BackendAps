...
public class GetFilesEricssonSftpExecutor
{
  ...
  public static void main(String[] args)
  {
    ...
    GetFilesEricssonSftpExecutor getFile = new GetFilesEricssonSftpExecutor(args[0]);
  ...
  public GetFilesEricssonSftpExecutor(String config)
  {
  ...
  private void GetFiles(String externalParam)
  {
    for (int source = 1; source <= 10; source++)
    {
      ...
      if ((this.ftpProp.isValid()) && (this.ftpProp.isGET_FTP()))
      {
        ...
        this.ftp.GetFilesEri2G(ftpProp.getFTP_REMOTE_DIR(), "*"+externalParam+"*", ftpProp.getFTP_FILEPATTERN());
        this.ftp.disConnect();
      }else
    	  continue;
    }
